...
var infox = [14, 16 ,11, 15, 18,  22 ,19 ,25 ,23, 18 ,22 , 17] ;

var infoy = [215, 325, 185, 332, 406 , 522, 412, 614 , 544, 421, 445, 408];
...
var plot = function(){
    ...
    points.attr("cy", function(d) {return d[1];});
    points.attr("r" , 5);
...
for (element in circles) {
    console.log(element);
    element.addEventListener("mouseover",label);
